...
import { MENU_SIDEBAR, SIDEBAR_MENU_ITEMS } from '@/admin/config';
import { useMenus } from '@/admin/providers';
import { ILayoutConfig, useLayout } from '@/admin/providers';
import { deepMerge } from '@/admin/utils';
import { Demo4LayoutConfig } from '.';
import { useMenuChildren } from '@/admin/components';
...
const Demo4LayoutProvider = ({ children }: PropsWithChildren) => {
  ...
  setMenuConfig('secondaryMenuItems', SIDEBAR_MENU_ITEMS);
