...
import { Menu, MenuItem, MenuToggle, useMenuCurrentItem } from '@/admin/components/menu';
...
import { ModalSearch } from '@/admin/partials/modals/search/ModalSearch';
    ...
    <Fragment>
      ...
      <div className="flex grow">
        ...
        <div className="flex flex-col lg:flex-row grow pt-[--tw-header-height] lg:pt-0">
          ...
          <div className="flex grow bg-[--tw-content-bg] dark:bg-[--tw-content-bg-dark] border border-gray-300 dark:border-gray-200 lg:ms-[--tw-sidebar-default-width] mt-0">
            <div
