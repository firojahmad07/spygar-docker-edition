      ...
      >
        ...
        <div className="flex gap-2.5 border border-primary-clarity rounded-md p-3 bg-primary-light">
          ...
          <div className="text-gray-700 text-xs">
            Use <span className="font-semibold text-gray-900">{initialValues.email}</span> username
            with <span className="font-semibold text-gray-900">{initialValues.password}</span> password.
          </div>
        </div>
