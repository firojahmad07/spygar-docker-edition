...
import { KeenIcon } from '@/core/components';
import { TMenuConfig, MenuItem, MenuLink, MenuTitle, MenuArrow, Menu } from '@/store/components/menu';
import {
  MegaMenuSubProfiles,
  MegaMenuSubAccount,
  MegaMenuSubNetwork,
  MegaMenuSubAuth,
  MegaMenuSubHelp
} from '@/store/partials/menu/mega-menu';
import { useShopLayout } from '../shopLayoutProvider';
import { MENU_MEGA } from '@/store/config';

const MegaMenuInner = () => {
  const desktopMode = useResponsive('up', 'lg');
  const [disabled, setDisabled] = useState(true); // Initially set disabled to true
  const { layout, sidebarMouseLeave, setMegaMenuEnabled } = useShopLayout();
