...
import { MiscCreateTeam } from '@/admin/partials/misc';
import { BlockList } from '@/admin/pages/account/security/privacy-settings';
import { Highlights, Teams } from '@/admin/pages/dashboards/demo1';
import { Integrations, ManageData } from '@/admin/pages/dashboards/demo2/blocks';
