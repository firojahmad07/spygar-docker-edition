...
import { MiscCreateTeam } from '@/store/partials/misc';
import { BlockList } from '@/store/pages/account/security/privacy-settings';
import { Highlights, Teams } from '@/store/pages/dashboards/demo1';
import { Integrations, ManageData } from '@/store/pages/dashboards/demo2/blocks';
