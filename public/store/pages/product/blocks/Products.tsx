...
import { DataGrid, KeenIcon , MenuIcon, Menu,MenuLink,MenuSub, MenuTitle, MenuItem, MenuSeparator, MenuToggle} from '@/store/components';
...
const DropdownCrudItem1 = () => {
  return (
    <MenuSub className="menu-default" rootClassName="w-full max-w-[175px]">
      <MenuItem path="#">
        <MenuLink path='/products/product/125'>
          <MenuIcon>
