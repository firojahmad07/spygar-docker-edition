...
const UserProfileHero = ({ image, name, info }: IUserProfileHeroProps) => {
  const buildInfo = (info: IUserProfileHeroInfo[]) => {
    return info.map((item, index) => {
      return (
        <div className="flex gap-1 items-center" key={`info-${index}`}>
          {item.icon && <KeenIcon icon={item.icon} className="text-gray-500 text-base" />}
          ...
          <Container>
            <div className="flex flex-col items-center gap-2 lg:gap-3 py-4 lg:py-5">
              ...
              <div className="flex items-center gap-1.5">
                <div className="text-lg leading-5 font-semibold text-gray-800">{name}</div>
