...
import { toAbsoluteUrl } from '@/store/utils';
import { NavbarDropdown } from '@/store/partials/navbar';
...
import {
  ...
  Projects,
  WorkExperience
} from '@/store/pages/public-profile/profiles/default';
              ...
              <div className="grid lg:grid-cols-3 gap-3 w-full items-center">
                ...
                <div className="flex items-center flex-col">
                  <div className="flex items-center gap-1.5 mb-2">
                    <a
                      href="#"
                      className="text-lg leading-5 font-semibold text-gray-800 hover:text-primary"
                    >
                      Jenny Klabbe
                    </a>
