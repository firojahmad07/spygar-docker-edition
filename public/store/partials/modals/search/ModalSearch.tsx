...
import { Modal, ModalContent, ModalBody, ModalHeader } from '@/admin/components/modal';
import { KeenIcon, Menu, MenuItem, MenuToggle } from '@/admin/components';
import { Tab, TabPanel, Tabs, TabsList } from '@/admin/components/tabs';
import { DropdownCrud2 } from '@/admin/partials/dropdowns/general';
