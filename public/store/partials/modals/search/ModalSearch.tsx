...
import { Modal, ModalContent, ModalBody, ModalHeader } from '@/store/components/modal';
import { KeenIcon, Menu, MenuItem, MenuToggle } from '@/store/components';
import { Tab, TabPanel, Tabs, TabsList } from '@/store/components/tabs';
import { DropdownCrud2 } from '@/store/partials/dropdowns/general';
