...
import { I18N_CONFIG_KEY, I18N_DEFAULT_LANGUAGE } from '@/store/i18n';
import { type LanguageType, type TranslationProviderProps } from '@/store/i18n';
import { getData, setData } from '@/store/utils';
