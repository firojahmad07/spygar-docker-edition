...
import { DefaultPage, Demo1DarkSidebarPage } from '@/store/pages/dashboards';
import {
  ProfileActivityPage,
  ProfileBloggerPage,
  CampaignsCardPage,
  ...
  ProfileTeamsPage,
  ProfileWorksPage
} from '@/store/pages/public-profile';
import {
  AccountActivityPage,
...
import {
  ...
  NetworkVisitorsPage
} from '@/store/pages/network';

import {
  ProductList,
} from '@/store/pages/product';


import { ShopLayouts } from '@/store/layouts/shop';
import { ErrorsRouting } from '@/store/errors';

const AppRoutingSetup = (): ReactElement => {
  return (
    <Routes>
        <Route element={<ShopLayouts />}>        
