module.exports = {
  content: ['index.html', './public/**/*.{ts,tsx}'],
  content: ['./public/**/*.{js,jsx,ts,tsx}', './templates/**/*.html.twig'],
  safelist: [
    'demo1',
    'hidden',
    'ki-filled',
  ...
  plugins: [
    require('./public/plugins/plugin'),
    require('./public/plugins/components/theme'),
    require('./public/plugins/components/breakpoints'),
    require('./public/plugins/components/typography'),
    require('./public/plugins/components/menu'),
    require('./public/plugins/components/dropdown'),
    require('./public/plugins/components/accordion'),
    require('./public/plugins/components/input'),
    require('./public/plugins/components/input-group'),
    require('./public/plugins/components/select'),
    require('./public/plugins/components/textarea'),
    require('./public/plugins/components/file-input'),
    require('./public/plugins/components/switch'),
    require('./public/plugins/components/checkbox'),
    require('./public/plugins/components/radio'),
    require('./public/plugins/components/range'),
    require('./public/plugins/components/container'),
    require('./public/plugins/components/image-input'),
    require('./public/plugins/components/modal'),
    require('./public/plugins/components/drawer'),
    require('./public/plugins/components/tooltip'),
    require('./public/plugins/components/popover'),
    require('./public/plugins/components/btn'),
    require('./public/plugins/components/btn-group'),
    require('./public/plugins/components/tabs'),
    require('./public/plugins/components/pagination'),
    require('./public/plugins/components/card'),
    require('./public/plugins/components/table'),
    require('./public/plugins/components/badge'),
    require('./public/plugins/components/rating'),
    require('./public/plugins/components/scrollable'),
    require('./public/plugins/components/progress'),
    require('./public/plugins/components/apexcharts'),
    require('./public/plugins/components/leaflet')
  ]
};
